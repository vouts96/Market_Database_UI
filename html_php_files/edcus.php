...
<?php
		...
		$sql = "UPDATE customer SET Card='$Card', Phone='$Phone', Name='$Name', Date_of_Birth='$Date_of_birth', Address='$Address', City='$City', Postal_code='$Postal_code', Family_members='$Family_members', Pet='$Pet', Points='$Points' WHERE Card='".$Card."'";
