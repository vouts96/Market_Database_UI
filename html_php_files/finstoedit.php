...
<div id="InSto" class="tabcontent">
  <h3 style="background-color:tomato;padding:10px 20px;font-size:30px;text-align:center">Give store data</h3>
  <form action="edsto.php" style="padding:20px 20px;font-size:30px;text-align:right;margin-right:42%">
	  <label for="Store_id">Store id:</label>
	  <input type="text"  name="store_id" id="Store_id" value="<?php echo $row['Store_id']; ?>"required><br>
	  ...
	  <input type="text" id="Operating_hours" name="hours" value="<?php echo $row['Operating_hours']; ?>"><br>
